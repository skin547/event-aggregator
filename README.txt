...
* please return a zipped file or a GitHub project that operates on the data as expected
...
Start the spark stream:
   cd spark
   mvn clean compile exec:java -D exec.mainClass="com.taboola.spark.SparkApp"
